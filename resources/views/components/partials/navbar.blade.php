        ...
        <ul class="flex items-center gap-4">
            ...
            <li class="relative">
                <a href="{{ route('notifications.index') }}" class="relative">
                    ...
                    @endphp
                    @if($unread > 0)
                        <span class="absolute top-0 right-0 bg-red-600 text-white text-xs font-semibold rounded-full w-5 h-5 flex items-center justify-center">
                            {{ $unread }}
                        </span>
                    @endif
                </a>
            ...
            <li class="relative" x-data="{ open: false }">
                ...
                <!-- Dropdown Menu -->
                <div x-show="open" @click.outside="open = false" class="absolute right-0 mt-2 w-48 bg-white border rounded shadow-lg py-2 z-50"
